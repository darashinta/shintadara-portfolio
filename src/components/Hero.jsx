  ...
  return (
    <section className="container px-4 pb-20 mx-auto sm:px-6 md:px-16 lg:px-2">
      ...
      <div className="flex flex-col-reverse items-center px-4 pt-20 md:flex-row gap-y-8 md:gap-x-8 sm:px-6 md:px-36">
        <img
          className="w-auto h-auto max-w-xs transition-transform duration-300 transform md:basis-1/3 hover:scale-110"
          src={ppimage}
        ...
        <div className="text-center md:basis-2/3 md:text-left">
          <h1 className="overflow-hidden text-3xl font-semibold transition-all duration-300 sm:text-[18px] md:text-5xl text-darkNavyBlue hover:tracking-widest hover:text-mediumPinkishBeige">
            Hola<span className="inline-block font-mono animate-wave">👋</span>{" "}
            aku Shinta murid teladan MAN 1
          </h1>
          <button
            ...
            onClick={() =>
              window.open(
                "https://drive.google.com/uc?export=download&id=105kXPcLXfVPpXY8_MNiA9om0yRwrS6UT",
                "_blank",
              )
            }
          >
      ...
      <div className="flex flex-col gap-2 px-4 mt-10 sm:px-6 md:px-36">
        ...
        <p className="text-base font-normal sm:text-lg text-darkNavyBlue">
          Website untuk kalian semua mengenal aku :)
        </p>
      </div>
      {/* Section Desc */}
      <div className="w-full md:w-[992px] h-auto flex flex-col gap-2 mt-2 px-4 sm:px-6 md:px-36">
        <p className="text-sm font-normal sm:text-base text-darkNavyBlue">
          Siswi
          <span className="font-semibold text-aquaBlue"> MAN 1 BANDA ACEH</span>
          , mencoba belajar pemograman secara otodidak dengan dibantu pengajaran
          oleh bapak Nauval Angkasah
        </p>
      </div>
    </section>
  );
