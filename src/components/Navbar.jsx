    ...
    <>
      <nav className="px-4 border-b-2 sm:px-6 md:px-16 lg:px-24 text-darkNavyBlue bg-offWhite border-darkNavyBlue">
        <div className="container flex flex-wrap items-center justify-between py-2">
          ...
          <Link
            to="/"
            className="hidden p-1 text-2xl font-bold transition-transform duration-300 md:inline hover:scale-110"
          >
            shinta<span className="text-aquaBlue">..</span>
          </Link>
          ...
          <div className="hidden space-x-6 font-medium md:flex ">
            <Link to="/" className="text-darkNavyBlue underline-from-right">
              Home
            </Link>
            <Link
              to="/about"
              className="text-darkNavyBlue underline-from-right"
            >
              About Me
            </Link>
            <Link
        ...
        <div className={isDropdownOpen ? "block" : "hidden"} id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link
              to="/"
              className="block px-3 py-2 text-base font-medium rounded-md text-darkNavyBlue hover:underline"
            >
              Home
            </Link>
            <Link
